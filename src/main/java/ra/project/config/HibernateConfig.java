...
public class HibernateConfig {
    ...
    public DataSource dataSource() {
        ...
        source.setUrl("jdbc:mysql://localhost:3306/final_project?createDatabaseIfNotExist=true");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("ra.project.entity"); // phat hiện các ClassMapping vs Table
